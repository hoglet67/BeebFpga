...
cat m128/basic4.rom       >> rom_image.bin
cat m128/adfs.rom         >> rom_image.bin
cat m128/view.rom         >> rom_image.bin
cat m128/terminal.rom     >> rom_image.bin

cat m128/mos.rom          >> rom_image.bin

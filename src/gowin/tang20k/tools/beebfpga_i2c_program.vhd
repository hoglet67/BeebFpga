   ...
   begin
      if rising_edge(clk) then
         case address is
           ...
           when "0000000101" => data <= "011101000";
           ...
           when "0000010010" => data <= "011101000";
           ...
           when "0000011111" => data <= "011101000";
           ...
           when "0000101100" => data <= "011101000";
           ...
           when "0000110100" => data <= "011100100";
           when "0000110101" => data <= "110100000";
           when "0000110110" => data <= "100000010";
           when "0000110111" => data <= "011111111";
           when "0000111000" => data <= "110100001";
           when "0000111001" => data <= "011000101";
           when "0000111010" => data <= "011000110";
           when "0000111011" => data <= "011000111";
           when "0000111100" => data <= "011001000";
           when "0000111101" => data <= "011001001";
           when "0000111110" => data <= "011111111";
           when "0000111111" => data <= "011100100";
           when "0001000000" => data <= "010110000";
           when "0001000001" => data <= "010100000";
           when "0001000010" => data <= "000000000";

...
--Command     : generate_target ProcessingSystemOnly.bd
--Design      : ProcessingSystemOnly
...
entity ProcessingSystemOnly is
  port (
  ...
  attribute CORE_GENERATION_INFO of ProcessingSystemOnly : entity is "ProcessingSystemOnly,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ProcessingSystemOnly,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of ProcessingSystemOnly : entity is "ProcessingSystemOnly.hwdef";
end ProcessingSystemOnly;

architecture STRUCTURE of ProcessingSystemOnly is
  component ProcessingSystemOnly_processing_system7_0_0 is
  port (
  ...
  end component ProcessingSystemOnly_processing_system7_0_0;
  signal UART1_RX_0_1 : STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of FCLK_CLK0_0 : signal is "XIL_INTERFACENAME CLK.FCLK_CLK0_0, CLK_DOMAIN ProcessingSystemOnly_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 50000000, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  UART1_RX_0_1 <= UART1_RX_0;
  UART1_TX_0 <= processing_system7_0_UART1_TX;
processing_system7_0: component ProcessingSystemOnly_processing_system7_0_0
     port map (
